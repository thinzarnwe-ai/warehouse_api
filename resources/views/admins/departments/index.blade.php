    ...
    <div class="py-8 px-4 sm:px-10 border-[#1a936f] ">
        ...
        <div class="mt-8 flex flex-col px-4 sm:px-6 lg:px-8">
            <div class="-my-2 -mx-4 sm:-mx-6 lg:-mx-8">
                <table class="min-w-full d-table border-separate border-spacing-y-1" id="permissionsTable">
                    ...
                    <tbody class="bg-white " id="tbody">
                        @foreach($departments as $key => $department)
                            <tr class="shadow-md rounded-full ">
                                <td class="bg-gray-50 bg-opacity-75 py-1 pl-4 pr-3 text-left text-sm font-semibold text-gray-700 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">{{ $departments->firstItem() + $key }}</td>
                                ...
                                <td class="border-r-2 rounded-lg border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">
                                    <div class="flex">
                                    <a data-id="{{ $department->id }}" class="editModal inline-flex items-center justify-center rounded-md border border-transparent bg-[#1a936f] p-2 text-sm font-bold shadow-md hover:bg-[#144d3b] hover:text-white focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 sm:w-auto mr-2" >
                                    ...
                                    <a id="btn-delete" data-id="{{ $department->id }}" data-url="{{ route('departments.destroy', $department->id) }}" class="deleteModal inline-flex items-center justify-center rounded-md border border-transparent bg-rose-700 p-2 text-sm font-bold shadow-md hover:bg-rose-900 hover:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:w-auto mr-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-white hover:text-white">
        ...
        <div class="fixed inset-0 z-10">
          ...
          >
            <div class="relative transition duration-300 overflow-y-auto ease-in-out transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl w-full sm:w-3xl sm:max-w-4xl sm:m-10 h-auto sm:p-6">
                <div class="card border border-green-700 rounded ">
                    <div class="card-header border-b-2">
                        <div class="flex px-4 py-2 justify-between items-center">
                            <h3 class="font-bold text-[#1a936f]">Create Department</h3>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form class="space-y-4" method="POST" action="" id="formData" enctype="multipart/form-data">
                            ...
                            <div class="mt-2 grid grid-cols-4 gap-4 sm:grid-cols-6">
                                ...
                                <div class="col-span-4 sm:col-span-6">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <select name="branch_id" class="block w-full min-w-0 flex-1 rounded-md shadow border-[#1a936f] focus:border-green-700 focus:ring-green-700 sm:text-sm py-2">
                                ...
                                <div class="col-span-4 sm:col-span-6">
                                    ...
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <input type="text" name="name" id="name" class="block w-full min-w-0 flex-1 rounded-md shadow border-[#1a936f] focus:border-green-700 focus:ring-green-700 sm:text-sm">
                                    </div>
                            ...
                            <div class="mt-5 gap-4 sm:flex">
                                <button type="submit" class="mt-2 sm:mt-0 inline-flex items-center justify-center rounded-md border border-transparent bg-[#1a936f] px-4 py-2 text-sm font-bold text-white shadow-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 sm:w-auto mr-2" id="btn-submit">Save</button>
                            </div>
                        </form>
