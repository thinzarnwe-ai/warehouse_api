...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="py-8 px-4 sm:px-10 border-[#1a936f] ">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <button type="button" data-action="" @click="addUser = true" class="inline-flex items-center justify-center rounded-md border border-transparent bg-[#1a936f] p-2 text-sm font-bold text-white shadow-md hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 sm:w-auto" id="openModal">
                        ...
                        @foreach($permissions as $key => $permission)
                            <tr class="shadow-md rounded-full ">
                                ...
                                <td class="border-r-2 rounded-lg border-gray-300 bg-gray-50 bg-opacity-75 py-1.5 p-4 text-left text-sm text-gray-900 backdrop-blur backdrop-filter sm:pl-6 lg:pl-8">
                                    <div class="flex">
                                    <a data-id="{{ $permission->id }}" class="editModal inline-flex items-center justify-center rounded-md border border-transparent bg-[#1a936f] p-2 text-sm font-bold shadow-md hover:bg-[#114d3b] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#1a936f] focus:ring-offset-2 sm:w-auto mr-2" >
                                    ...
                                    <a data-id="{{ $permission->id }}" data-url="{{ route('permissions.destroy', $permission->id) }}" class="deleteModal inline-flex items-center justify-center rounded-md border border-transparent bg-rose-700 p-2 text-sm font-bold shadow-md hover:bg-rose-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-rose-500 focus:ring-offset-2 sm:w-auto mr-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-white hover:text-white">
                ...
                <div class="card border border-cyan-700 rounded ">
                    <div class="card-header border-b-2">
                        <div class="flex px-4 py-2 justify-between items-center">
                            <h3 class="font-bold text-[#1a936f]">Create Permission</h3>
                    ...
                    <div class="card-body p-4">
                        <form class="space-y-4"  method="post" id="formData" enctype= "multipart/form-data">
                          ...
                          <div class="mt-5 gap-4 sm:flex">
                                <button type="submit"  class="mt-2 sm:mt-0 inline-flex items-center justify-center rounded-md border border-transparent bg-[#1a936f] px-4 py-2 text-sm font-bold text-white shadow-md hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 sm:w-auto mr-2" id="btn-create" > Save</button>
                            </div>
                        </form>
